...
const GroupUpdate = () => {
  ...
  const handleInsert = async e => {
    ...
    try{
      await axios.put(`http://localhost:58888/groups/${artistId}`, artist)
      navigate("/CRUD")
    } catch(err) {
      console.log(err)
    }
  ...
  return (
    <div className='form'>
      <h1>Update Group</h1>
      <input type="text" defaultValue={artistData.artist_name} placeholder='group name' onChange={changeProp} name="artist_name"/>
