...
const SoloInsert = () => {
  ...
  const handleInsert = async e => {
    ...
    try{
      await axios.post("http://localhost:58888/solos", artist)
      navigate("/CRUD")
    } catch(err) {
      console.log(err)
    }
  ...
  return (
    <div className='form'>
      ...
      <input type="text" placeholder='artist name' onChange={changeProp} name="artist_name"/>
